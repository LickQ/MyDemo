	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<font>作者注册</font>USER REGISTER
				<form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/Autregister.action" method="post" style="margin-top: 5px;" >
					<div class="form-group">
						<label for="username" class="col-sm-2 control-label">用户名</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="authorname" id="authorname-id" onblur="checkName()"
								placeholder="请输入用户名">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control"  id="age" name="age" onblur="checkage()"
								placeholder="年龄">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="telephone" name="telephone" onblur="checktel()"
								placeholder="电话号">
						</div>
					</div>
					<div class="form-group">
...
<script>
  function checkName(){
	  var userName=document.getElementById("authorname-id");
	  if(userName.value==""){
          alert("用户名不能为空");
		  userName.value="";
	  }
